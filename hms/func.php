...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> NSTU Online Healthcare Zone</a>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">Doctors Section</a>
       <a class="list-group-item list-group-item-action" id="list-attend-list" data-toggle="list" href="#list-attend" role="tab" aria-controls="settings">Testing Report</a>
    </div><br>
  </div>
  <div class="col-md-8">
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <center><h4>Insert Your appointment</h4></center><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="doctor" class="form-control" >
				      <option value="Dr. Hasnat Riaz">Dr. Hasnat Riaz</option>
				      <option value="Dr. Kabir Hossain">Dr. Kabir Hossain</option>
				      <option value="Dr. Mamun Hasan">Dr. Mamun Hasan</option>
                      <option value="Dr. Imdadul Hoque">Dr. Imdadul Hoque</option>
                      <option value="Dr. Shamsul Huda">Dr. Shamsul Huda</option>
					  <option value="Dr. Zannatul Mawa">Dr. Zannatul Mawa</option>
                      <option value="Dr. Nocikheta chakraborti">Dr. Nocikheta chakraborti</option>
                    </select>
                  </div><br><br>
                  ...
                  <div class="col-md-4">
                    <input type="submit" name="entry_submit" value="Submit Your Appointment" class="btn btn-primary" id="inputbtn">
                  </div>
